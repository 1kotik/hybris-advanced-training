...
<template:page pageTitle="${pageTitle}">
	...
	<cms:pageSlot position="ProductWarrantySection" var="comp" element="div" class="productDetailsPageProductWarrantySection">
		<cms:component component="${comp}" element="div" class="productDetailsPageProductWarrantySection-component"/>
	</cms:pageSlot>
