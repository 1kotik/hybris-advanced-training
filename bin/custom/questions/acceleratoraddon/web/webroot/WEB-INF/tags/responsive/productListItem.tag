...
<li class="${fn:escapeXml(productTagClasses)}">
    <ycommerce:testId code="test_searchPage_wholeProduct">
        ...
        <c:if test="${not empty product.warrantyYears}">
            <div class="product--listing--warranty" style="display: inline-block; margin-left: 6px;">
                <img src="${originalContextPath}/_ui/addons/questions/responsive/common/images/warrantyIcon.svg"
                     class="product-listing-warranty-icon"
                     style="width: 24px; height: 24px; display: inline-block; vertical-align: middle;"/>
                <span class="product-listing-warranty" style="margin-left: 4px;">
